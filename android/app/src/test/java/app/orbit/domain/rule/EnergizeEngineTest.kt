...
class EnergizeEngineTest {

    private val T0 = Instant.parse("2026-01-01T12:00:00Z")
    private val params = RuleParams.Energize()   // all defaults
    private val engine = EnergizeEngine(params)
    ...
    fun `skip count extends cooldown by skipPenaltyHours per skip`() {
        ...
        // Energize: base=24, penalty=12, skipCount=2 -> 24 + 24 = 48h (under max=168)
